...
interface BeachViewClubCardProps extends CardComponentProps {
  side: 'front' | 'back';
}

export default function BeachViewClubCard({ data, side, cardRef, isDownload = false }: BeachViewClubCardProps) {
  ...
  useEffect(() => {
    ...
    const templatePath = side === 'front' 
      ? '/card-templates/clubs/BeachView_front.svg'
      : '/card-templates/clubs/BeachView_back.svg';
    ...
    return (
      <div ref={ref} style={cardWrapperStyle}>
        <div style={{ 
          ...
          Loading Beach View Club {side} card...
        </div>
      </div>
    );
  }
  ...
  if (side === 'front') {
    return (
      <div ref={ref} style={cardWrapperStyle}>
        {!imageError ? (
          <img 
            src="/card-templates/clubs/BeachView_front.svg" 
            alt="Beach View Club Front Card Template"
            style={{ 
              width: '100%', 
              height: '100%', 
              position: 'absolute',
...
<div style={{ 
  ...
  return (
    <div ref={ref} style={cardWrapperStyle}>
      {!imageError ? (
        <img 
          src="/card-templates/clubs/BeachView_back.svg" 
          alt="Beach View Club Back Card Template"
          style={{ 
            width: '100%', 
            height: '100%', 
            position: 'absolute',
