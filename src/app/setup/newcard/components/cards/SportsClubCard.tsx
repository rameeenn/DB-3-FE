...
export default function SportsClubCard({ data, side, cardRef, isDownload = false }: SportsClubCardProps) {
  ...
  console.log('Sports Club Card - Profile Picture URL:', data.profilePictureUrl);

  // Preload template
  useEffect(() => {
    const img = new Image();
    const templatePath = side === 'front' 
      ? '/card-templates/clubs/Sports_front.svg'
      : '/card-templates/clubs/Sports_back.svg';
  ...
  const handleImageLoad = () => {
    console.log('Sports Club image loaded successfully:', data.profilePictureUrl);
    setImageLoading(false);
    setProfileImageError(false);
  };

  const handleImageError = () => {
    console.error('Sports Club image failed to load:', data.profilePictureUrl);
    setImageLoading(false);
  ...
  if (side === 'front') {
    return (
      <div ref={ref} style={cardWrapperStyle}>
        {!imageError ? (
          <img 
            src="/card-templates/clubs/Sports_front.svg" 
            alt="Sports Club Front Card Template"
            style={{ 
              width: '100%', 
              height: '100%', 
              position: 'absolute',
  ...
  return (
    <div ref={ref} style={cardWrapperStyle}>
      {!imageError ? (
        <img 
          src="/card-templates/clubs/Sports_back.svg" 
          alt="Sports Club Back Card Template"
          style={{ 
            width: '100%', 
            height: '100%', 
            position: 'absolute',
