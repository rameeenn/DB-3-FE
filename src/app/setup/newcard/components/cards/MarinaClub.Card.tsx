...
interface MarinaClubCardProps extends CardComponentProps {
  side: 'front' | 'back';
}

export default function MarinaClubCard({ data, side, cardRef, isDownload = false }: MarinaClubCardProps) {
  ...
  useEffect(() => {
    ...
    const templatePath = side === 'front' 
      ? '/card-templates/clubs/Marina_front.svg'
      : '/card-templates/clubs/Marina_back.svg';
  ...
  if (side === 'front') {
    return (
      <div ref={ref} style={cardWrapperStyle}>
        {!imageError ? (
          <img 
            src="/card-templates/clubs/Marina_front.svg" 
            alt="Marina Club Front Card Template"
            style={{ 
              width: '100%', 
              height: '100%', 
              position: 'absolute',
  ...
  return (
    <div ref={ref} style={cardWrapperStyle}>
      {!imageError ? (
        <img 
          src="/card-templates/clubs/Marina_back.svg" 
          alt="Marina Club Back Card Template"
          style={{ 
            width: '100%', 
            height: '100%', 
            position: 'absolute',
